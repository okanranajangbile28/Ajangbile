...
const OgboniBlogSection = () => {
  ...
  return (
    <section className="bg-purple-950 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {blogs.length > 0 && (
          <div className="text-center mt-12">
            <Link
              to="/ogboni"
              className="inline-flex items-center gap-2 border-2 border-yellow-400 text-yellow-300 px-8 py-3 rounded-full font-semibold hover:bg-yellow-400 hover:text-purple-950 transition"
            >
              Explore Ogboni
              <ArrowRight size={18} />
            </Link>
