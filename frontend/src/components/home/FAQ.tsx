...
function FAQ() {
  ...
  const faqs = [
...

    {
      ...
      answer:
        "Ogboni from the word Ogbo, which directly translates to the aged, is the branch of ogboni that comprises of elderly men and women in the society which supervises politics and day to day governance of the Yoruba society, so their history is as old as the politics of the Yoruba people. Worthy of note is that there is another translation of the word ogbo, which means a chunk of wood capable of causing damage which serve as the stem for the spiritual faction of ogboni.      Their history is blended with facts and fiction, some parts of it can be traced into Ifa (ogbe ate, irete meji, orogun meji, irosun ogbe, etc.), while some parts of it are stories orally passed down from one ogboni to the other. e.g the story of about the exploit of igbo kokobojo which also has its roots in the odu Ifa oyeku odi. Also, there are stories about Orunmila about his role in the fraternity as an Oluwo and a patron where he helped organize the ikorita of awo which deals with positioning and title. A book about the full history of ogboni is coming out very soon from Oluwo Ifasakin Ogunorokin.",
    },
    {
