...
function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: "Will i become rich just by joining the Ogboni Fraternity?",
      answer:
        "No, Ogboni fraternity is not a get rich quick scheme. However, expatiating further on the controversies surrounding this particular question, a lot of people are confused by the historical inaccuracies of the ogboni fraternity exploits. In the ogboni fraternity, we need to remember that since the time of creation of the Yoruba people, the ogboni had been in charge of managing and governing the affairs of the Oduduwa nation. They selected and depose kings, they govern, they maintain law and order, they manage critical natural and human resources. They monitor trades, control trade routes and they are in charge of selecting officials. This is equivalent to the lower and upper chamber of the state and Federal government (senators and honorables ), and obviously, senators and politicians are not only wealthy, but highly influential in our society today. As and edge over todays system of governance, the Ogboni's title is not elective rather hereditary passed down from father to son, mother to daughter of the same lineage, so this means that they are able to create generational wealth. Before the advent of the colonialists, the Ogboni's were known to be very rich, powerful, influential and highly spiritual people, these were the characteristics that made them famous and cemented their achievement to stand the test of time. Eventually, when the colonialists came, they replaced our traditional Ogboni system with a more christian affiliated organization called the Reformed Ogboni Fraternity, so most of the influential people in the circa 1914 downwards were replaced by the rof and rof usurped the duties of the ogboni fraternity especially in the judiciary and political division of government, that is why a lot of people are confused and convinced that joining ogboni is a get rich quick sceheme. However, with continuous effort, dissemination of correct information and action from every corners in the Oduduwa land, we believe that the Ogboni can be restored back to its old glory. Ogboni can take over its rightful position as the epitome of law and order and the benefactor of the community. If we ever get to this point, its going to be a lot easier to make people rich by joining Ogboni. However, a lot of ogboni 'wanna be's' flaunts themselves and feed off people's ignorance and people's desperacy to become rich overnight by promising them quick wealth in the ogboni fraternity. The best most ogboni fraternities can offer now is Oshole which is rituals to give money and if its a credible organization, they will only offer it to members whom they can trust. Another point that made a lot of people believe that Ogbonis are able to conjure money is that the ogboni fraternity is a fraternity that sits on top of nexus of great power, knowledge and spiritual secret, since they have fraternal bond between themselves, they are able to join hands together to bless an initiate with proper spiritual product that can increase the persons earning ability. In conclusion, Ogboni should not be reduced to a get rich quick scheme rather it is a society where you put in work, where you dedicate yourself and where you put in a lot of loyalty to start experiencing a positive turn around.",
    },
    {
