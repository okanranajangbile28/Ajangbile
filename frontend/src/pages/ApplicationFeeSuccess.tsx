    ...
    <section className="min-h-screen bg-gray-100 flex items-center justify-center px-6">
      <div className="bg-white max-w-2xl w-full rounded-2xl shadow-xl p-10 text-center">
        ...
        <p className="text-gray-700 text-lg leading-8 mb-8">
          Thank you for completing your membership application fee payment.
          <br />
        ...
        <div className="bg-green-50 border border-green-300 rounded-xl p-6 mb-8">
          <p className="text-green-700 font-semibold text-lg">
            Your membership application is now
          </p>
        ...
        <p className="text-gray-700 leading-8 mb-10">
          Your application has been submitted to the administration for review.
          Once your application is approved, you will receive an email
          containing the available initiation payment packages and further
          instructions.
        </p>
